...
const Fasilitas = ({ className, ...props }) => {
	return <div {...props} id="fasilitas" className={`flex jc-c ${className}`}>
		{window.location.pathname.includes('/home') && <div className="flex w-1/4 jc-c ai-fs flex-col p-5">
			<h4>Fasilitas</h4>
		...
		<div className="flex w-1/4 flex-col p-5">
